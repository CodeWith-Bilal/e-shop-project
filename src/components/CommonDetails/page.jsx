              ...
              <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                ...
                <div className="mt-10 flex flex-col items-center justify-between space-y-4 botder-t border-b py-4 sm:flex-row sm:space-y-0">
                  <div className="flex items-end">
                    <h1
                      className={`text-3xl font-bold mr-2 text-gray-200 ${
                  ...
                  <button
                    ...
                    className="mt-1.5 inline-block btn btn-outline btn-accent px-5 py-3 text-xs font-medium tracking-wide uppercase text-white"
                  >
                ...
                <div className="lg:col-span-3">
                  <div className="border-b border-gray-200">
                    <nav className="flex gap-4">
                      <a
                        href="#"
                        className="border-b-2 border-gray-500 py-4 text-sm font-medium text-gray-200"
                      >
                        Description
                      </a>
                    </nav>
                  </div>
                  <div className="mt-8 flow-root sm:mt-12 text-gray-200">
