                  ...
                  {allOrdersForAllUsers && allOrdersForAllUsers.length ? (
                    <ul className="flex flex-col gap-4">
                      {allOrdersForAllUsers.map((item) => (
                        <li
                          key={item._id}
                          className="bg-gray-700 shadow p-5 flex flex-col space-y-3 py-6 text-left"
                        >
                          <div className="flex">
                            <h1 className="font-bold text-lg mb-3 flex-1 text-gray-200">
                              #order: {item._id}
                            </h1>
                          ...
                          <div className="flex gap-5">
                            <button className="disabled:opacity-50 mt-5 mr-5  inline-block bg-black rounded-lg text-white px-5 py-3 text-xs font-medium uppercase tracking-wide">
                              {item.isProcessing
                                ? "Order is Processing"
                                : "Order is delivered"}
                            </button>
                            <button
                              ...
                              className="disabled:bg-gray-600 disabled:text-white mt-5 mr-5  inline-block btn btn-outline btn-info text-xs  uppercase "
                            >
                              {componentLevelLoader &&
