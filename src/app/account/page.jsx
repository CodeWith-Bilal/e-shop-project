        ...
        <section>
          <div className="mx-auto bg-gray-800 px-4 sm:px-6 lg:px-8">
            <div className="bg-white shadow">
              <div className="p-6 sm:p-12 bg-gray-700">
                ...
                <button onClick={()=>router.push('/orders')} className="mt-5  inline-block btn btn-outline btn-accent px-5 py-3 text-xs font-medium uppercase tracking-wide">
                  View Your Orders
                </button>
                <div className="mt-6">
                  <h1 className="font-bold text-lg text-gray-200">Your Addresses :</h1>
                  {pageLevelLoader ? (
                    <PulseLoader
                      color={"#000000"}
                        ...
                        addresses.map((item) => (
                          <div className="border p-6" key={item._id}>
                            ...
                            <button
                              ...
                              className="mt-5  inline-block btn btn-outline btn-error px-5 py-3 text-xs font-medium uppercase tracking-wide"
                            >
                              {componentLevelLoader &&
                ...
                <div className="mt-4">
                  <button
                    ...
                    className="mt-5  inline-block btn btn-outline btn-primary px-5 py-3 text-xs font-medium uppercase tracking-wide"
                  >
